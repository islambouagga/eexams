...
<div class="wrapper">
    ...
    <div class="content-wrapper">
        ...
        <aside class="main-sidebar">
            ...
            <section class="sidebar">
                ...
                <ul class="sidebar-menu" data-widget="tree">
                    ...
                    <p class="float">
                        <i class="btn btn-block btn-warning btn-lg my-float"
                           style="background-color: rgb(34, 45, 50); border-color: rgb(34, 45, 50); font-size: 196%;"
                           id="demo">
                        </i>
                    </p>
                    {{--                    <li>--}}
        ...
        <section class="content container-fluid">
            ...
            <div class="box-body table-responsive no-padding" onmousedown="WhichButton(event)">
                                ...
                                @foreach($exam->questions()->where('order',$o)->get() as $Q)
                                    ...
                                    <!-- radio -->
                                        <div class="callout callout-danger">
                                            <div class="radio">
                                                <label>
                                                    <input type="radio" name="answer{{$Q->id_Question}}"
                                    ...
                                    @if($Q->questiontable_type=="SAQuestion")
                                        ...
                                        <div class="form-group ">
                                            ...
                                            <input type="text" name="answer{{$Q->id_Question}}" id="tit"
                                                   class="form-control ">
                                    ...
                                    @if($Q->questiontable_type=="MRQuestion")
                                        <div class="callout callout-warning "
                                             style="background-color: aqua;margin-right: -30px;margin-left: -23px;">
