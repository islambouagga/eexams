        ...
        <aside class="main-sidebar">
            ...
            <section class="sidebar">
                ...
                <ul class="sidebar-menu" data-widget="tree">
                    ...
                    <li class="active"><a href="{{route('teacher.groups.create')}}"><i class="fa fa-group"></i>
                            ...
                            <div font="19px" class="box-group" id="accordion">
                                ...
                                <div class="panel box box-success">
                                    ...
                                    <div id="collapseTwo" class="panel-collapse collapse in">
                                        <div class="box-body">
                                            This page allows you to create a new group of students
                                        </div>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="modal-dialog">
                        <div class="modal-content">
                            <div class="modal-header">
                                ...
                                <h4 class="modal-title">Cancel creation of group</h4>
                            </div>
                            <div class="modal-body">
                                <p>Do you want cancel creation of group !!!</p>
                            </div>
